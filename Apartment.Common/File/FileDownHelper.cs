...
namespace Apartment.Common
{
    public class FileDownHelper
    {
        ...
        public static void DownLoad(string FileName,bool isMapPath = true)
        {
            string filePath = string.Empty;
            if (isMapPath)
            {
                filePath = MapPathFile(FileName);
            }else
            {
                filePath = FileName;
            }
        ...
        public static void DownLoadFromRemote(string FileURL, string FileName)
        {
            try
            {
