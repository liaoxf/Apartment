...
namespace Apartment.Common
{
    ...
    {
        private static string _conn = ConfigurationManager.AppSettings["Cache_Redis_Configuration"] ?? "127.0.0.1:6379";
        ...
        /// <returns><c>true</c> if XXXX, <c>false</c> otherwise.</returns>
        public static bool Set<T>(string key, T t, TimeSpan? ts = default(TimeSpan?))
        {
