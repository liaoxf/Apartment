...
namespace Apartment.Common
{
    ...
    {
        private static string NFineDESKey = "nfine_desencrypt_2016";
        #region ========nfine加密========
        /// <summary>
        /// 加密
        /// </summary>
        ...
        {
            return Encrypt1(Text, NFineDESKey);
        }
        /// <summary> 
        /// 加密数据 
        /// </summary> 
        ...
        /// <param name="Text"></param>
        /// <returns></returns>
        public static string Decrypt1(string Text)
        {
            if (!string.IsNullOrEmpty(Text))
            {
                return Decrypt1(Text, NFineDESKey);
            }
            else
            {
                return "";
        ...
        /// <param name="sKey"></param> 
        /// <returns></returns> 
        public static string Decrypt1(string Text, string sKey)
        {
            DESCryptoServiceProvider des = new DESCryptoServiceProvider();
            int len;
            len = Text.Length / 2;
