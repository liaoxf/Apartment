...
namespace Apartment.Model.ModelsExp
{
    ...
    public class siteconfig
    {
        ...
        private string _kfwebmail = "";
        private string _swwebmail = "";
        ...
        private string _courseextension = "";
        ...
        private string _sysencryptstring = "Shzhuoyan";
        private string _ffmpegtool = "";//ffmpeg执行文件的路径
        private string _regprotocol = "";//注册协议
        private decimal _exchangeproportion = 1;//一个积分可以兑换？元
        private int _reporttime = 10;//报备所需时间（天）
        private string _hotsearch = "";//热门搜索
        ...
        /// 客服邮箱
        /// </summary>
        public string kfwebmail
        {
            get { return _kfwebmail; }
            set { _kfwebmail = value; }
        }
        /// <summary>
        /// 商务合作
        /// </summary>
        public string swwebmail
        {
            get { return _swwebmail; }
            set { _swwebmail = value; }
        }
        /// <summary>
        /// 公司名称
        /// </summary>
        ...
        /// 一个积分可以兑换？元
        /// </summary>
        public decimal exchangeproportion
        {
            get { return _exchangeproportion; }
            set { _exchangeproportion = value; }
        }
        /// <summary>
        /// 报备时间(天)
        /// </summary>
        ...
        /// <summary>
        /// 课件上传类型courseextension 
        /// </summary>
        public string courseextension
        {
            get { return _courseextension; }
            set { _courseextension = value; }
        }
        /// <summary>
        /// 文件上传大小
        /// </summary>
        ...
        {
            get { return _ffmpegtool; }
            set { _ffmpegtool = value; }
        }
        #endregion
