...
{
    [Serializable]
	public partial class contract : EntityExt
    {
        ...
        public class _
        {
            ...
            /// 主键
            /// </summary>
            public readonly static Field Id = new Field("Id", "contract", "主键");
						/// <summary>
            /// 订单号
            /// </summary>
            public readonly static Field OrderNo = new Field("OrderNo", "contract", "订单号");
						/// <summary>
            /// 出租方ID号
            /// </summary>
            public readonly static Field SignatoryId = new Field("SignatoryId", "contract", "出租方ID号");
						/// <summary>
            /// 出租方姓名
            /// </summary>
            public readonly static Field SignatoryName = new Field("SignatoryName", "contract", "出租方姓名");
						/// <summary>
            /// 出租方联系电话
            /// </summary>
            public readonly static Field SignatoryPhone = new Field("SignatoryPhone", "contract", "出租方联系电话");
						/// <summary>
            /// 出租方身份证号
            /// </summary>
            public readonly static Field SignatoryIDCard = new Field("SignatoryIDCard", "contract", "出租方身份证号");
						/// <summary>
            /// 承租方ID号
            /// </summary>
            public readonly static Field LessorId = new Field("LessorId", "contract", "承租方ID号");
						/// <summary>
            /// 承租方姓名
            /// </summary>
            public readonly static Field LessorName = new Field("LessorName", "contract", "承租方姓名");
						/// <summary>
            /// 承租方联系电话
            /// </summary>
            public readonly static Field LessorPhone = new Field("LessorPhone", "contract", "承租方联系电话");
						/// <summary>
            /// 承租方身份证号
            /// </summary>
            public readonly static Field LessorIDCard = new Field("LessorIDCard", "contract", "承租方身份证号");
						/// <summary>
            /// 开始时间
            /// </summary>
            public readonly static Field ContractSignTime = new Field("ContractSignTime", "contract", "开始时间");
						/// <summary>
            /// 结束时间
            /// </summary>
            public readonly static Field ContractDueTime = new Field("ContractDueTime", "contract", "结束时间");
						/// <summary>
            /// 房子租金（大写）
            /// </summary>
            public readonly static Field BContractAmount = new Field("BContractAmount", "contract", "房子租金（大写）");
						/// <summary>
            /// 房子租金
            /// </summary>
            public readonly static Field ContractAmount = new Field("ContractAmount", "contract", "房子租金");
						/// <summary>
            /// 首次付款
            /// </summary>
            public readonly static Field FirstPayment = new Field("FirstPayment", "contract", "首次付款");
						/// <summary>
            /// 房屋押金
            /// </summary>
            public readonly static Field HouseDeposit = new Field("HouseDeposit", "contract", "房屋押金");
						/// <summary>
            /// 房租总月数
            /// </summary>
            public readonly static Field TotalMonth = new Field("TotalMonth", "contract", "房租总月数");
						/// <summary>
            /// 房租总月数（首次）
            /// </summary>
            public readonly static Field FTotalMonth = new Field("FTotalMonth", "contract", "房租总月数（首次）");
						/// <summary>
            /// 房租总金额（首次）
            /// </summary>
            public readonly static Field FTotalMoney = new Field("FTotalMoney", "contract", "房租总金额（首次）");
						/// <summary>
            /// 审核状态：0表示待审核；1表示审核成功；2表示审核失败；
            /// </summary>
            public readonly static Field AuditStatus = new Field("AuditStatus", "contract", "审核状态：0表示待审核；1表示审核成功；2表示审核失败；");
						/// <summary>
            /// 房屋的ID号
            /// </summary>
            public readonly static Field HouseId = new Field("HouseId", "contract", "房屋的ID号");
						/// <summary>
            /// 合同html
            /// </summary>
            public readonly static Field ContractHtml = new Field("ContractHtml", "contract", "合同html");
						/// <summary>
            /// 合同备注
            /// </summary>
            public readonly static Field ContractRemark = new Field("ContractRemark", "contract", "合同备注");
						/// <summary>
            /// 软删除：0表示未删除；1表示已删除
            /// </summary>
            public readonly static Field IsDel = new Field("IsDel", "contract", "软删除：0表示未删除；1表示已删除");
						/// <summary>
            /// 合同生成时间
            /// </summary>
            public readonly static Field AddTime = new Field("AddTime", "contract", "合同生成时间");
						/// <summary>
            /// 合同更新时间
            /// </summary>
            public readonly static Field LastUpdateTime = new Field("LastUpdateTime", "contract", "合同更新时间");
						/// <summary>
            /// 合同生成方式：0表示线上；1表示线下；
            /// </summary>
            public readonly static Field GenerateWay = new Field("GenerateWay", "contract", "合同生成方式：0表示线上；1表示线下；");
						/// <summary>
            /// 市
            /// </summary>
            public readonly static Field City = new Field("City", "contract", "市");
						/// <summary>
            /// 区
            /// </summary>
            public readonly static Field District = new Field("District", "contract", "区");
						/// <summary>
            /// 房源具体地址
            /// </summary>
            public readonly static Field DetailAddress = new Field("DetailAddress", "contract", "房源具体地址");
						/// <summary>
            /// 小区名称
            /// </summary>
            public readonly static Field AreasName = new Field("AreasName", "contract", "小区名称");
						/// <summary>
            /// （栋号）弄
            /// </summary>
            public readonly static Field BuildingNO = new Field("BuildingNO", "contract", "（栋号）弄");
						/// <summary>
            /// 室号
            /// </summary>
            public readonly static Field RoomNO = new Field("RoomNO", "contract", "室号");
						/// <summary>
            /// 房型规格
            /// </summary>
            public readonly static Field HSpec = new Field("HSpec", "contract", "房型规格");
						/// <summary>
            /// 出租面积
            /// </summary>
            public readonly static Field RentalArea = new Field("RentalArea", "contract", "出租面积");
						/// <summary>
            /// 租金方式
            /// </summary>
            public readonly static Field RentMoneyWay = new Field("RentMoneyWay", "contract", "租金方式");
						/// <summary>
            /// 签约日期
            /// </summary>
            public readonly static Field SignTime = new Field("SignTime", "contract", "签约日期");
						/// <summary>
            /// 是否同步
            /// </summary>
            public readonly static Field IsSync = new Field("IsSync", "contract", "是否同步");
