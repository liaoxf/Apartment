...
{
    [Serializable]
	public partial class sys_modulebutton : EntityExt
    {
        ...
        public override void SetPropertyValues(IDataReader reader)
        {
							...
							this._F_Location = DataUtils.ConvertValue<int?>(reader["F_Location"]);
							this._F_JsEvent = DataUtils.ConvertValue<string>(reader["F_JsEvent"]);
							this._F_UrlAddress = DataUtils.ConvertValue<string>(reader["F_UrlAddress"]);
							this._F_Split = DataUtils.ConvertValue<bool>(reader["F_Split"]);
        ...
        public override void SetPropertyValues(DataRow row)
        {
							...
							this._F_Location =  DataUtils.ConvertValue<int?>(row["F_Location"]);
							this._F_JsEvent =  DataUtils.ConvertValue<string>(row["F_JsEvent"]);
							this._F_UrlAddress =  DataUtils.ConvertValue<string>(row["F_UrlAddress"]);
							this._F_Split =  DataUtils.ConvertValue<bool>(row["F_Split"]);
