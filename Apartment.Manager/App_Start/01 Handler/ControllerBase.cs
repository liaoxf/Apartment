...
namespace Apartment.Manager
{
    ...
    {
        public virtual string UserCode { get; set; } = Apartment.Common.OperatorProvider.Provider.GetCurrent().UserCode;
        public virtual string UserName { get; set; } = Apartment.Common.OperatorProvider.Provider.GetCurrent().UserName;
        ...
        ///// <param name="senderName">消息发送人姓名</param>
        ///// <param name="senderAccount">消息发送人账号</param>
        ///// <param name="sendContent">消息内容</param>
        //protected static void AddMsgsendLog(MsgType msgType, string senderID, string senderName, string senderAccount, string sendContent)
        //{
        //    msgsendlog msgsendlogModel = new msgsendlog()
        //    {
        ...
        //        IsDel = 0
        //    };
        //    Db.MySqlContext_User.Insert(msgsendlogModel);
        //}
        ///// <summary>
        /////  根据Id获取房屋基础信息
        ///// </summary>
        ...
        ///// <returns></returns>
        //protected static house GetHousesById(int intHouseId, bool isIngoreDel = true)
        //{
        //    if (isIngoreDel)
        //    {
        //        return Db.MySqlContext_House.From<house>().Where(d => d.Id == intHouseId).ToFirst();
        //    }
        //    else
        //    {
        //        return Db.MySqlContext_House.From<house>().Where(d => d.IsDel == 0 && d.Id == intHouseId).ToFirst();
        //    }
        //}
        ///// <summary>
        ///// 根据ID获取用户信息
        ...
        //{
        //    return Db.MySqlContext_User.From<users>().Where(d => d.IsDel == 0 && d.Id == userID).ToFirst();
        //}
        ///// <summary>
        ///// 根据订单ID获取订单信息
        ///// </summary>
        ...
        ///// <returns></returns>
        //public orders GetOrderById(int orderID, bool isIngoreDel = false)
        //{
        //    if (isIngoreDel)
        //    {
        //        return Db.MySqlContext_Order.From<orders>().Where(d => d.Id == orderID).ToFirst();
        //    }
        //    else
        //    {
        //        return Db.MySqlContext_Order.From<orders>().Where(d => d.IsDel == 0 && d.Id == orderID).ToFirst();
        //    }
        //}
        ///// <summary>
        ///// 根据订单号获取订单信息
        ...
        ///// <returns></returns>
        //public orders GetOrdersByOrderNo(string orderNo, bool isIngoreDel = false)
        //{
        //    if (isIngoreDel)
        //    {
        //        return Db.MySqlContext_Order.From<orders>().Where(d => d.OrderNo == orderNo).ToFirst();
        //    }
        //    else
        //    {
        //        return Db.MySqlContext_Order.From<orders>().Where(d => d.IsDel == 0 && d.OrderNo == orderNo).ToFirst();
        //    }
        //}
        ///// <summary>
        ///// 添加订单日志
        ...
        ///// <param name="strOrderStatus">订单状态</param>
        ///// <param name="strLogRemark">备注</param>
        ///// <param name="intOperatorID">操作人ID号</param>
        ///// <param name="strOperatorName">操作人姓名</param>
        //protected static void AddOrderTrackLog(DbTrans trans, string strOrderNo, int intOrderStatus, string strLogRemark, string strOperatorID, string strOperatorName)
        //{
        //    ordertracklog ordertracklogModel = new ordertracklog()
        //    {
        //        OrderNo = strOrderNo,
        //        OrderStatus = intOrderStatus,
        //        LogRemark = strLogRemark,
        //        OperatorId = strOperatorID,
        //        OperatorName = strOperatorName,
        //        AddTime = DateTime.Now,
        //        IsDel = 0
        //    };
        //    Db.MySqlContext_Order.Insert(trans, ordertracklogModel);
        //}
        //protected static void AddOrderTrackLog(string strOrderNo, int intOrderStatus, string strLogRemark, string strOperatorID, string strOperatorName)
        //{
        //    ordertracklog ordertracklogModel = new ordertracklog()
        //    {
        //        OrderNo = strOrderNo,
        ...
        //        IsDel = 0
        //    };
        //    Db.MySqlContext_Order.Insert(ordertracklogModel);
        //}
        ///// <summary>
        ///// 获取订单个数，（存入缓存中）
        ///// </summary>
        ///// <param name="intUserId">用户的ID号</param>
        ///// <returns></returns>
        //protected static int GetOrdersCountByUserId(int intUserId)
        //{
        //    ////判断缓存中是否存在订单数量
        //    object ObjUserOrderCount = RedisHelper.StringGet(ZFX365ManagerKey.CACHE_USER_ORODER_WITH_NOCONTRACT_COUNT + intUserId);
        //    if (ObjUserOrderCount != null)
        //    {
        //        //存在直接返回
        //        return Convert.ToInt32(ObjUserOrderCount);
        //    }
        //    else
        //    {
        //        //不存在，获取，设置
        //        //【1】获取
        //        int IntUserOrderCount = Db.MySqlContext_Order.Count<orders>(d => d.IsDel == 0 && d.IsGenerateContract == 0 && d.LeaseCustomerId == intUserId);
        //        RedisHelper.StringSet(ZFX365ManagerKey.CACHE_USER_ORODER_WITH_NOCONTRACT_COUNT + intUserId, IntUserOrderCount.ToString());
        //        return IntUserOrderCount;
        //    }
        //}
        ///// <summary>
        ///// 获取配置项，（存入缓存中）
        ///// </summary>
        ///// <returns></returns>
        //protected static SysConfig GetConfig()
        //{
        //    ////判断缓存中是否存在订单数量
        //    SysConfig ObjSysConfig = RedisHelper.Get<SysConfig>(ZFX365ManagerKey.CACHE_SYS_CONFIG);
        ...
        //        //不存在，设置
        //        RedisHelper.Set<SysConfig>(ZFX365ManagerKey.CACHE_SYS_CONFIG, sysConfigModel);
        ...
        ///// </summary>
        ///// <param name="intUserId">用户的ID号</param>
        //protected static void SetOrdersCountByUserId(int intUserId)
        //{
        //    //【1】获取
        //    int IntUserOrderCount = Db.MySqlContext_Order.Count<orders>(d => d.IsDel == 0 && d.IsGenerateContract == 0 && d.LeaseCustomerId == intUserId);
        //    //【2】设置
        ...
        ///// </summary>
        ///// <param name="intUserId">用户的ID号</param>
        //protected static int GetOrderCountByUserId(int intUserId)
        //{
        //    return Db.MySqlContext_Order.Count<orders>(
        //        d => d.IsDel == 0
        //        && d.LeaseCustomerId == intUserId
        //        && (
        //           d.OrderStatus == Convert.ToInt32(OrderStatus.已创建意向单) ||
        //           d.OrderStatus == Convert.ToInt32(OrderStatus.预约看房中) ||
        //           d.OrderStatus == Convert.ToInt32(OrderStatus.已创建正式订单) ||
        //           d.OrderStatus == Convert.ToInt32(OrderStatus.已出价)
        //         ));
        //}
